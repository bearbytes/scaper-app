  ...
  return (
    <Grid columnWidth={250} gap="M">
      {props.categories.map(category => (
        <Card>
          <Label bold text={category.categoryName} />
          <Table
            rows={category.skills}
            columns={[
              {
                flex: 5,
                renderCell: skill => <Label text={skill.skillName} />,
              },
              {
                renderCell: skill => (
                  <Label text={skill.skillCount1.toString()} />
                ),
              },
              {
                renderCell: skill => (
                  <Label text={skill.skillCount2.toString()} />
                ),
              },
              {
                renderCell: skill => (
                  <Label text={skill.skillCount3.toString()} />
                ),
              },
            ]}
          />
